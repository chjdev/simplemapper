...
import org.chjdev.simplemapper.impl.SimpleMapMapper;
...
public class Example {
    ...
    public static void main(String[] args) throws InstantiationException, IllegalAccessException, NoSuchMethodException, IllegalArgumentException, InvocationTargetException {
        Map<String, Object> obj = ExampleFactory.create();
        System.out.println(obj);
        SimpleMapMapper mapper = SimpleMapMapper.getInstance();
        ExampleMapped ret = mapper.map(obj, ExampleMapped.class);
